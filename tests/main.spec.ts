...
it('sets caching headers', async ({request}) => {
  for (const pathname of ['/en', '/en/pathnames', '/es', '/es/rutas']) {
...
<xhtml:link rel="alternate" hreflang="de" href="http://localhost:3000/es" />
</url>
<url>
...
<xhtml:link rel="alternate" hreflang="de" href="http://localhost:3000/es/rutas" />
</url>
<url>
<loc>http://localhost:3000/es/rutas</loc>
<xhtml:link rel="alternate" hreflang="en" href="http://localhost:3000/en/pathnames" />
<xhtml:link rel="alternate" hreflang="de" href="http://localhost:3000/es/rutas" />
</url>
</urlset>
